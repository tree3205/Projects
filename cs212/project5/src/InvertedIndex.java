...
public class InvertedIndex 
{
	 ...
	 * 	
	 * @param subindex the given sub InvertedIndex instance
	 */
	public void addAll(InvertedIndex subindex)
	{
		...
		try
		{
			for(String word : subindex.invertedIndexMap.keySet())
			{
				...
				{
					invertedIndexMap.put(word, subindex.invertedIndexMap.get(word));
				}
				else
				{
					Map.Entry<String, ArrayList<Integer>> entry = subindex.invertedIndexMap.get(word).firstEntry();
