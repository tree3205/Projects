...
public class LoginUserServlet extends LoginBaseServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (request.getParameter("pwchange") != null) {
				out.println("<p>Password changed!");
				out.println("Login with your new password below.</p>");
			}
			...
			System.out.println("Unable to prepare response body.");
			ex.printStackTrace();
		}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			System.out.println("Unable to process login form.");
			ex.printStackTrace();
		}
	}
