...
class Graph:
    ...
    def __repr__(self) :
        return "%s, %s" % (self.adjlist, self.vertices)
...
### above.
    def buildGraph(self, infile) :
            ...
            try:
                for line in inFile:
                    ...
                    if (isVertex == True) & (isEdges == False) :
                        ...
                        self.vertices[vertex.name] = (vertex.lat, vertex.longitude)
        ...
        return self.adjlist, self.vertices
...
if __name__ == '__main__' :
    ...
    g.adjlist, g.vertices = g.buildGraph(infile)
    ...
    if output != '':
        ...
        print 'Vertices: %s' % g.vertices
        print '==============='
        print 'AdjacentList: %s' % g.adjlist
        print '==============='
        if startNode:
            pathInfo = g.dijkstra(startNode)
