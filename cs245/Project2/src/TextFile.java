...
public class TextFile {
	 ...
	 * program to exit. (This method should probably really throw an exception
	 * instead of halting the program on an error, but I'm trying to make your
	 * code a little simplier)
	 * 
	...
	/**
	 * Read in the next character from the input file This method is only valid
	 * for input files, and will throw an halt program execution if called on an
	 * output file. (This method should probably really throw an exception
	 * instead of halting the program on an error, but I'm trying to make your
	 * code a little more simple) This method will also halt execution if you try
	 ...
	 * files, and will halt execution if called on an input file. (This method
	 * should probably really throw an exception instead of halting the program
	 * on an error, but I'm trying to make your code a little simplier)
	 * 
	 * @param c
